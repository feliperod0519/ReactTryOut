...
import PageError from '../src/components/Error.jsx'
  ...
  return (
    <>
      ...
      <Modal open={errorUpdatingPlaces}>
        {errorUpdatingPlaces && <PageError title="An error occurred" 
      ...
      <main>
        {error && <PageError title="An error occurred!" message={error.message}/>}
        {!error && <Places
